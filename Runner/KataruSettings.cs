...
namespace Kataru
{
    ...
    public class KataruSettings : ScriptableObject
    {
        ...
        // Tooltips
        public const string sourcePathTooltip = "The path where Kataru source code is installed in this project, relative to the project root. Standard installations use Assets/Third Party/Kataru.",
        ...
        internal static KataruSettings Load(bool createIfMissing = false)
        {
            ...
            if (createIfMissing && settings == null)
            {
                ...
                settings.sourcePath = "Assets/Third Party/Kataru";
    ...
    public class KataruSettingsProvider : SettingsProvider
    {
        ...
        class Styles
        {
            public static GUIContent sourcePath = new GUIContent("Kataru Source Path"),
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            EditorGUILayout.PropertyField(serializedSettings.FindProperty("sourcePath"), Styles.sourcePath);
            EditorGUILayout.HelpBox(KataruSettings.sourcePathTooltip, MessageType.None);
